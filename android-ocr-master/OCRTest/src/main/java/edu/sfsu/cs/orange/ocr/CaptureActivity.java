...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  public void onCreate(Bundle icicle) {
    ...
    btn2=(Button)findViewById(R.id.btnTumListe);
  ...
  public void goTo(){
    ...
    Cursor cursor = myDb.getAllData("select * from sertifika where title LIKE '%" + lastResult.getText() + "%'");
    if(!cursor.moveToFirst()){

      Context context = getApplicationContext();
      CharSequence text = "Fotoğrafını çektiğiniz e kod bulunmamaktadır!!! tekrar deneyin.";
      ...
      String text = "sertifika_adi";
      Intent in = new Intent(this , ContentEcodes.class);
      in.putExtra(text,lastResult.getText());
      startActivity(in);
    }

  }

  public void CaptureActivityIntent(){
  ...
  public void dosyadanOku(){
    myDb= new DatabaseHelper(this);
    certificates=oku.dosyadanOkumaCer(this , "EKodlari.txt");
